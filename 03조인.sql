...
select b.emp_no,b.last_name,a.salary
from salaries a
...
where a.emp_no = b.emp_no and b.dept_no=c.dept_no and d.emp_no = a.emp_no and a.emp_no = e.emp_no
order by concat(a.first_name, " ", a.last_name);
...
where a.emp_no = b.emp_no
	...
	and b.to_date < date_format(curdate(), "%Y-%m-%d");
...
select concat(a.first_name, " ", a.last_name), c.title, b.salary
